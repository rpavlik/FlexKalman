    ...
    struct SplitQ {
        ...
        getJacobian(Eigen::Quaterniond const &measInCamSpace,
            ...
            auto tmp15 = q2.w() * tmp0 + q2.w() * tmp1 + q2.w() * tmp2 +
                         ...
                         q2.z() * tmp0 + q2.z() * tmp1 + q2.z() * tmp3 + tmp11 -
                         tmp12 - tmp13 - tmp14 + tmp6 + tmp9;
            auto tmp16 = std::abs(tmp15);
            auto tmp17 = std::pow(tmp16, -1. / 2.);
            auto tmp18 = std::sqrt(q2.w() * tmp3 + q2.x() * tmp0 +
                                   q2.y() * tmp1 + q2.z() * tmp2 - tmp11 +
                                   tmp12 + tmp13 + tmp14 + tmp16 - tmp6 - tmp9);
            ...
            auto tmp57 = tmp30 + tmp32 - tmp34 - tmp36 + tmp37 + tmp39 + tmp41 +
                         tmp43 + tmp45 + tmp47 + tmp49 + tmp51 - tmp52 - tmp54 -
                         tmp55 - tmp56;
            ...
            auto tmp67 = -1. / 2. * tmp30 - 1. / 2. * tmp32 +
                         (1. / 2.) * tmp34 + (1. / 2.) * tmp36 -
                         1. / 2. * tmp37 - 1. / 2. * tmp39 - 1. / 2. * tmp41 -
                         1. / 2. * tmp43 - 1. / 2. * tmp45 - 1. / 2. * tmp47 -
                         1. / 2. * tmp49 - 1. / 2. * tmp51 + (1. / 2.) * tmp52 +
                         (1. / 2.) * tmp54 + (1. / 2.) * tmp55 +
            ...
            auto tmp95 = tmp74 + tmp75 - tmp76 - tmp77 + tmp79 + tmp80 + tmp81 +
                         tmp82 + tmp83 + tmp85 + tmp87 + tmp89 - tmp90 - tmp92 -
                         tmp93 - tmp94;
            auto tmp96 = tmp66 * tmp95 - 1. / 2. * tmp74 - 1. / 2. * tmp75 +
                         (1. / 2.) * tmp76 + (1. / 2.) * tmp77 -
                         1. / 2. * tmp79 - 1. / 2. * tmp80 - 1. / 2. * tmp81 -
                         1. / 2. * tmp82 - 1. / 2. * tmp83 - 1. / 2. * tmp85 -
                         1. / 2. * tmp87 - 1. / 2. * tmp89 + (1. / 2.) * tmp90 +
                         (1. / 2.) * tmp92 + (1. / 2.) * tmp93 +
                         (1. / 2.) * tmp94;
            ...
            auto tmp118 = tmp100 + tmp101 - tmp102 - tmp103 + tmp104 + tmp105 +
                          tmp106 + tmp107 + tmp108 + tmp109 + tmp111 + tmp113 -
            ...
            auto tmp119 =
                ...
                (1. / 2.) * tmp114 + (1. / 2.) * tmp115 + (1. / 2.) * tmp116 +
                (1. / 2.) * tmp117 + tmp118 * tmp66;
            ...
            ret << tmp23 + tmp25 + tmp28 + tmp57 * tmp60 - tmp57 * tmp61 -
                ...
                tmp60 * tmp95 - tmp61 * tmp95 - tmp62 * tmp95 - tmp63 * tmp95 +
                    tmp65 * tmp96 + tmp68 * tmp96 + tmp69 * tmp96 -
                    tmp70 * tmp96 + tmp71 + tmp72 - tmp73,
                ...
                tmp120 * tmp95 - tmp121 * tmp95 - tmp122 * tmp95 -
                    ...
                    tmp126 * tmp96 + tmp127 * tmp96 + tmp128 + tmp23 + tmp27,
                ...
                tmp118 * tmp132 - tmp118 * tmp133 - tmp118 * tmp134 -
                    ...
                    tmp119 * tmp138 + tmp119 * tmp139 + tmp128 + tmp20 + tmp22 +
                    tmp28;
            return ret;
        }
    };
