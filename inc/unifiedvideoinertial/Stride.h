/**	@file
    ...
    This GUID can help identify the project:
   d1dbc94e-e863-49cf-bc08-ab4d9f486613
...
class Stride {
  public:
    Stride(const unsigned int n) : _stride(n), _step(0) {}

    void advance() { _step = (_step + 1) % _stride; }
    ...
    operator bool() const { return _step == 0; }
