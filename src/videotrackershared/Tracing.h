...
#ifdef VIDEOTRACKER_COMMON_TRACING_ENABLED
...
#else  // VIDEOTRACKER_COMMON_TRACING_ENABLED ^^ // vv
       // !VIDEOTRACKER_COMMON_TRACING_ENABLED
    struct MainTracePolicy {
...
#endif // !VIDEOTRACKER_COMMON_TRACING_ENABLED
