...
void MediaSampleExchange::signalSampleProduced(
    IMediaSample *sample, videotracker::util::TimeValue const &timestamp) {
...
void MediaSampleExchange::signalSampleProduced(IMediaSample *sample) {
    signalSampleProduced(sample, videotracker::util::time::getNow());
}
...
void MediaSampleExchange::signalSampleConsumed() {
    VIDEOTRACKER_ASSERT_MSG(sample_ != nullptr,
