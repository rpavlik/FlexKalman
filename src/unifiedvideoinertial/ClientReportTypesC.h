...
typedef UVBI_Vec3 OSVR_PositionState;

/** @brief Type of orientation state */
typedef UVBI_Quaternion OSVR_OrientationState;

/** @brief Type of pose state */
typedef OSVR_Pose3 OSVR_PoseState;

/** @brief Type of linear velocity state */
typedef UVBI_Vec3 OSVR_LinearVelocityState;
...
typedef struct OSVR_IncrementalQuaternion {
    UVBI_Quaternion incrementalRotation;
    double dt;
...
typedef UVBI_Vec3 OSVR_LinearAccelerationState;
...
typedef UVBI_Vec3 OSVR_DirectionState;
