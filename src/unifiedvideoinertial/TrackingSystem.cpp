...
namespace uvbi {
    ...
    ImageOutputDataPtr TrackingSystem::performInitialImageProcessing(
        util::TimeValue const &tv, cv::Mat const &frame,
    ...
    validateTargetPointerFromUpdateList(TrackedBodyTarget *targetPtr) {
        ...
        VIDEOTRACKER_ASSERT_MSG(targetPtr != nullptr,
                                "We should never be "
    ...
    void TrackingSystem::calibrationHandleIMUData(
        BodyId id, util::TimeValue const &tv, Eigen::Quaterniond const &quat) {
    ...
    bool TrackingSystem::isRoomCalibrationComplete() {
        ...
        m_impl->roomCalibCompleteCached =
            ::videotracker::uvbi::isRoomCalibrationComplete(*this);
