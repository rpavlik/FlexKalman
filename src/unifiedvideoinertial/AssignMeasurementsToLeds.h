    ...
    class AssignMeasurementsToLeds {
      ...
      public:
        ...
        void populateStructures() {
            VIDEOTRACKER_ASSERT_MSG(!populated_,
        ...
        LedAndMeasurement getMatch(bool verbose = false) {
            ...
            VIDEOTRACKER_ASSERT_MSG(isTopValid(),
            ...
            /// consumed it.
            VIDEOTRACKER_ASSERT(!isTopValid());
        ...
        size_type size() const {
            ...
            VIDEOTRACKER_ASSERT_MSG(populated_, "Should have called "
      ...
      private:
        ...
        void markTopConsumed() {
            ...
            VIDEOTRACKER_ASSERT(!isLedValid(elt));
            VIDEOTRACKER_ASSERT(!isMeasValid(elt));
        }
        ...
        /// Resizes for you too.
        void popHeap() {
            VIDEOTRACKER_ASSERT_MSG(!distanceHeap_.empty(),
