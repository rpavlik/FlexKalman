...
namespace uvbi {
    ...
    void RoomCalibration::processVideoData(TrackingSystem const &sys,
        ...
        Eigen::Vector3d rTcln = flexkalman::util::quat_ln(rTc);
...
// Already got data from a different IMU
        ...
        VIDEOTRACKER_ASSERT_MSG(m_imuBody == body,
    ...
    bool RoomCalibration::postCalibrationUpdate(TrackingSystem &sys) {
        ...
        Eigen::Quaterniond iRc =
            flexkalman::util::quat_exp(m_rTc_ln_accum / m_steadyVideoReports);
    ...
    RoomCalibration::getCalibrationYaw(BodyId const &body) const {
        VIDEOTRACKER_ASSERT_MSG(calibrationComplete(),
                                "Not valid to call "
