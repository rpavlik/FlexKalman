...
namespace uvbi {
    ...
    ImageSourcePtr openHDKCameraDirectShow(bool highGain) {
        ...
        // Check firmware version
        {
            ...
            case videotracker::uvbi::FirmwareStatus::Good:
                break;
            case FirmwareStatus::Future:
                std::cerr
                    ...
                    << std::endl;
                break;
            case videotracker::uvbi::FirmwareStatus::UpgradeRequired:
            case videotracker::uvbi::FirmwareStatus::UpgradeUseful:
                std::cerr
                ...
                /// versions?
                break;
            case videotracker::uvbi::FirmwareStatus::Unknown:
                std::cerr
            ...
            if (firmwareStatus ==
                videotracker::uvbi::FirmwareStatus::UpgradeRequired) {
    ...
    void DirectShowImageSource::retrieveColor(
        cv::Mat &color, videotracker::util::TimeValue &timestamp) {
