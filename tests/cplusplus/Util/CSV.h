...
namespace util {
    ...
    namespace detail {
        ...
        /// Utility class used in conjunction with videotracker::util::CSV, to
        /// store a single table cell's column header and data value temporarily
        /// until it is added to the row. Construct with the `cell()` helper
        /// functions.
